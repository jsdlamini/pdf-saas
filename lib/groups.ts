...
export const STUDY_GROUPS: StudyGroup[] = [
  { id: "group-a", name: "Group A", schedule: "Friday, 1 – 3 PM", capacity: GROUP_CAPACITY, sessionCount: DEFAULT_SESSION_COUNT },
  { id: "group-b", name: "Group B", schedule: "Wednesday, 10:00 – 11:50 AM", capacity: GROUP_CAPACITY, sessionCount: DEFAULT_SESSION_COUNT },
  { id: "group-c", name: "Group C", schedule: "Monday, 1 – 3 PM", capacity: GROUP_CAPACITY, sessionCount: DEFAULT_SESSION_COUNT },
  { id: "group-d", name: "Group D", schedule: "Tuesday, 4 – 6 PM", capacity: GROUP_CAPACITY, sessionCount: DEFAULT_SESSION_COUNT },
  { id: "group-e", name: "Group E", schedule: "Thursday, 4 – 6 PM", capacity: GROUP_CAPACITY, sessionCount: DEFAULT_SESSION_COUNT },
  { id: "group-f", name: "Group F", schedule: "Wednesday, 2 – 4 PM", capacity: GROUP_CAPACITY, sessionCount: DEFAULT_SESSION_COUNT },
];
