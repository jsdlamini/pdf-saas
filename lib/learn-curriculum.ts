...
export const LEARN_LESSONS: LearnLesson[] = [
  // ─────────────────────────── Python ───────────────────────────
  {
    ...
    challenges: [
      ...
      py("Print `Eswatini is growing!` exactly.", "Eswatini is growing!"),
  ...
  },
  {
    ...
    challenges: [
      ...
      py("Create `name = 'Eswatini'` and print it.", "Eswatini"),
      ...
      py("Create `country = 'Eswatini'` and `region = 'Hhohho'`, print both on one line.", "Eswatini Hhohho"),
  ...
  },
  {
    ...
    challenges: [
      ...
      py("Define `greet(name)` returning `\"Hello \" + name`; print `greet(\"Eswatini\")`.", "Hello Eswatini"),
  ...
  // ─────────────────────────── C++ ───────────────────────────
  {
    ...
    challenges: [
      ...
      cpp("Print `Eswatini is growing!` exactly.", "Eswatini is growing!"),
