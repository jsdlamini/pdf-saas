...
export const LEARN_LESSONS: LearnLesson[] = [
  // ─────────────────────────── Python ───────────────────────────
  {
    ...
    challenges: [
      ...
      wordPy("A grain depot's terminal prints a three-line daily card: the title `GRAIN DEPOT`, a line of ten dashes, then the word `Open`. Print the three lines exactly.", "GRAIN DEPOT\n----------\nOpen"),
      wordPy("A clinic prints a reminder with a heading, a blank line, then an instruction. Print `Reminder`, one empty line, then `Take medicine after meals.`", "Reminder\n\nTake medicine after meals."),
      wordPy("A school prints a timetable header with each subject followed by its time. Print `Math`, then `09:00`, then `Physics`, then `11:00`, each on its own line.", "Math\n09:00\nPhysics\n11:00"),
    ],
  },
  {
    id: "py-vars",
    ...
    challenges: [
      ...
      wordPy("A shop records the opening stock (240 units), deliveries received (60) and units sold (85). Store all three in variables and print the closing stock (opening + deliveries - sold).", "215"),
      wordPy("A weather station records the minimum (9) and maximum (27) temperatures of the day. Store both and print the daily temperature range (maximum minus minimum).", "18"),
      wordPy("A budget tracks an income of 5000 and three expenses: 1200, 850 and 640. Store each in a variable and print the amount left after all expenses.", "2310"),
    ],
  },
  {
    id: "py-arithmetic",
    ...
    challenges: [
      ...
      wordPy("A mill buys maize at 12 per bag and sells at 18 per bag. It sold 240 bags. Print the total profit ((sell price - buy price) times the number of bags).", "1440"),
      wordPy("A tank is filled at 40 litres per minute for 15 minutes, after which 120 litres are used. Print the water remaining in the tank.", "480"),
      wordPy("A farmer plants maize on 2.5 hectares and expects 3.8 tonnes per hectare. Print the total expected harvest as a whole number of tonnes (use floor division).", "9"),
    ],
  },
  {
    id: "py-input",
    ...
    challenges: [
      ...
      wordPy("A sensor logs three temperature readings as text: `20`, `24` and `22`. Convert each to a number and print their whole-number average (use floor division).", "22"),
      wordPy("A form stores a student's marks in three subjects as text: `68`, `74` and `59`. Convert each to a number and print the total.", "201"),
      wordPy("A receipt stores a price as `1250` (in cents) and a quantity as `4`. Convert both, multiply to get the total in cents, then print the amount in whole currency units (divide by 100).", "50"),
    ],
  },
  {
    id: "py-if",
    ...
    challenges: [
      ...
      wordPy("A crop is at risk if rainfall is below 500 mm OR the temperature exceeds 35 degrees. This season recorded 480 mm of rain and 33 degrees. Print `Risk` if either condition holds, otherwise `Safe`.", "Risk"),
      wordPy("A loan is approved only if the applicant's income is at least 3000 AND their credit score is at least 600. An applicant has income 4200 and score 580. Print `Approved` if both hold, otherwise `Denied`.", "Denied"),
      wordPy("A store gives a 10% discount for orders over 500, a 5% discount for orders over 200, and no discount otherwise. An order totals 350. Print the discount percentage (10, 5, or 0).", "5"),
    ],
  },
  {
    id: "py-for",
    ...
    challenges: [
      ...
      wordPy("A farmer records the rainfall in millimetres over 7 days: 12, 8, 15, 6, 11, 9 and 14. Use a loop to add them and print the total.", "75"),
      wordPy("A class has six exam scores: 55, 71, 48, 66, 80 and 59. Use a loop to count how many scores are 60 or above, and print the count.", "3"),
      wordPy("Print a table of squares for the numbers 1 to 8, one per line, formatted as `n: square`.", "1: 1\n2: 4\n3: 9\n4: 16\n5: 25\n6: 36\n7: 49\n8: 64"),
    ],
  },
  {
    id: "py-while",
    ...
    challenges: [
      ...
      wordPy("A loan of 1000 is repaid at 200 per month. Print the remaining balance each month until it reaches 0, starting at 1000.", "1000\n800\n600\n400\n200\n0"),
      wordPy("A savings account starts at 100 and earns a fixed 30 per month. Print the balance each month until it reaches or exceeds 250.", "130\n160\n190\n220\n250"),
      wordPy("A number is repeatedly halved using whole-number division. Start at 640 and print each value until you reach 5.", "640\n320\n160\n80\n40\n20\n10\n5"),
    ],
  },
  {
    id: "py-lists",
    ...
    challenges: [
      ...
      wordPy("A market records the prices of six vegetables: 12, 7, 9, 15, 6 and 11. Print the difference between the highest and the lowest price.", "9"),
      wordPy("A school records attendance over six days: 95, 88, 92, 90, 85 and 97. Print how many days attendance was 90 or above.", "4"),
      wordPy("A shop tracks five days of sales: 210, 340, 180, 290 and 260. Print the average sale as a whole number (total divided by count).", "256"),
    ],
  },
  {
    id: "py-functions",
    ...
    challenges: [
      ...
      wordPy("Write a function `grade(score)` that returns `Pass` for 50 or more and `Fail` otherwise. Print `grade(73)` and `grade(41)` on separate lines.", "Pass\nFail"),
      wordPy("Write a function `area_circle(r)` that returns `3.14 * r * r`. Print `area_circle(10)` as a whole number (use int()).", "314"),
      wordPy("Write a function `is_leap(year)` that returns `True` when the year is divisible by 4. Print the result for 2024 and for 2023 on separate lines.", "True\nFalse"),
    ],
  },
  {
    id: "py-fizzbuzz",
    ...
    challenges: [
      ...
      wordPy("A machine labels items 1 to 20: print `Fizz` for multiples of 3, `Buzz` for multiples of 5, `FizzBuzz` for multiples of both, and the number otherwise.", "1\n2\nFizz\n4\nBuzz\nFizz\n7\n8\nFizz\nBuzz\n11\nFizz\n13\n14\nFizzBuzz\n16\n17\nFizz\n19\nBuzz"),
      wordPy("Print all the prime numbers from 2 to 20, one per line. A prime has no divisors other than 1 and itself.", "2\n3\n5\n7\n11\n13\n17\n19"),
      wordPy("Compute and print the sum of all numbers from 1 to 100 that are divisible by 3 or by 5.", "2418"),
    ],
  },
  ...
  // ─────────────────────────── C++ ───────────────────────────
  {
    ...
    challenges: [
      ...
      wordCpp("A grain depot's terminal prints a three-line daily card: the title `GRAIN DEPOT`, a line of ten dashes, then the word `Open`. Print the three lines exactly.", "GRAIN DEPOT\n----------\nOpen"),
      wordCpp("A clinic prints a reminder with a heading, a blank line, then an instruction. Print `Reminder`, one empty line, then `Take medicine after meals.`", "Reminder\n\nTake medicine after meals."),
      wordCpp("A school prints a timetable header with each subject followed by its time. Print `Math`, then `09:00`, then `Physics`, then `11:00`, each on its own line.", "Math\n09:00\nPhysics\n11:00"),
    ],
  },
  {
    id: "cpp-vars",
    ...
    challenges: [
      ...
      wordCpp("A shop records the opening stock (240 units), deliveries received (60) and units sold (85). Store all three in variables and print the closing stock (opening + deliveries - sold).", "215"),
      wordCpp("A weather station records the minimum (9) and maximum (27) temperatures of the day. Store both and print the daily temperature range (maximum minus minimum).", "18"),
      wordCpp("A budget tracks an income of 5000 and three expenses: 1200, 850 and 640. Store each in a variable and print the amount left after all expenses.", "2310"),
    ],
  },
  {
    id: "cpp-arithmetic",
    ...
    challenges: [
      ...
      wordCpp("A mill buys maize at 12 per bag and sells at 18 per bag. It sold 240 bags. Print the total profit ((sell price - buy price) times the number of bags).", "1440"),
      wordCpp("A tank is filled at 40 litres per minute for 15 minutes, after which 120 litres are used. Print the water remaining in the tank.", "480"),
      wordCpp("A farmer plants maize on 2.5 hectares and expects 3.8 tonnes per hectare. Print the total expected harvest as a whole number of tonnes (use floor division).", "9"),
    ],
  },
  {
    id: "cpp-input",
    ...
    challenges: [
      ...
      wordCpp("A sensor logs three temperature readings as text: `20`, `24` and `22`. Convert each to a number and print their whole-number average (use floor division).", "22"),
      wordCpp("A form stores a student's marks in three subjects as text: `68`, `74` and `59`. Convert each to a number and print the total.", "201"),
      wordCpp("A receipt stores a price as `1250` (in cents) and a quantity as `4`. Convert both, multiply to get the total in cents, then print the amount in whole currency units (divide by 100).", "50"),
    ],
  },
  {
    id: "cpp-if",
    ...
    challenges: [
      ...
      wordCpp("A crop is at risk if rainfall is below 500 mm OR the temperature exceeds 35 degrees. This season recorded 480 mm of rain and 33 degrees. Print `Risk` if either condition holds, otherwise `Safe`.", "Risk"),
      wordCpp("A loan is approved only if the applicant's income is at least 3000 AND their credit score is at least 600. An applicant has income 4200 and score 580. Print `Approved` if both hold, otherwise `Denied`.", "Denied"),
      wordCpp("A store gives a 10% discount for orders over 500, a 5% discount for orders over 200, and no discount otherwise. An order totals 350. Print the discount percentage (10, 5, or 0).", "5"),
    ],
  },
  {
    id: "cpp-for",
    ...
    challenges: [
      ...
      wordCpp("A farmer records the rainfall in millimetres over 7 days: 12, 8, 15, 6, 11, 9 and 14. Use a loop to add them and print the total.", "75"),
      wordCpp("A class has six exam scores: 55, 71, 48, 66, 80 and 59. Use a loop to count how many scores are 60 or above, and print the count.", "3"),
      wordCpp("Print a table of squares for the numbers 1 to 8, one per line, formatted as `n: square`.", "1: 1\n2: 4\n3: 9\n4: 16\n5: 25\n6: 36\n7: 49\n8: 64"),
    ],
  },
  {
    id: "cpp-while",
    ...
    challenges: [
      ...
      wordCpp("A loan of 1000 is repaid at 200 per month. Print the remaining balance each month until it reaches 0, starting at 1000.", "1000\n800\n600\n400\n200\n0"),
      wordCpp("A savings account starts at 100 and earns a fixed 30 per month. Print the balance each month until it reaches or exceeds 250.", "130\n160\n190\n220\n250"),
      wordCpp("A number is repeatedly halved using whole-number division. Start at 640 and print each value until you reach 5.", "640\n320\n160\n80\n40\n20\n10\n5"),
    ],
  },
  {
    id: "cpp-arrays",
    ...
    challenges: [
      ...
      wordCpp("A market records the prices of six vegetables: 12, 7, 9, 15, 6 and 11. Print the difference between the highest and the lowest price.", "9"),
      wordCpp("A school records attendance over six days: 95, 88, 92, 90, 85 and 97. Print how many days attendance was 90 or above.", "4"),
      wordCpp("A shop tracks five days of sales: 210, 340, 180, 290 and 260. Print the average sale as a whole number (total divided by count).", "256"),
    ],
  },
  {
    id: "cpp-functions",
    ...
    challenges: [
      ...
      wordCpp("Write a function `grade(score)` that returns `Pass` for 50 or more and `Fail` otherwise. Print `grade(73)` and `grade(41)` on separate lines.", "Pass\nFail"),
      wordCpp("Write a function `area_circle(r)` that returns `3.14 * r * r`. Print `area_circle(10)` as a whole number (use int()).", "314"),
      wordCpp("Write a function `is_leap(year)` that returns `True` when the year is divisible by 4. Print the result for 2024 and for 2023 on separate lines.", "True\nFalse"),
    ],
  },
  {
    id: "cpp-fizzbuzz",
    ...
    challenges: [
      ...
      wordCpp("A machine labels items 1 to 20: print `Fizz` for multiples of 3, `Buzz` for multiples of 5, `FizzBuzz` for multiples of both, and the number otherwise.", "1\n2\nFizz\n4\nBuzz\nFizz\n7\n8\nFizz\nBuzz\n11\nFizz\n13\n14\nFizzBuzz\n16\n17\nFizz\n19\nBuzz"),
      wordCpp("Print all the prime numbers from 2 to 20, one per line. A prime has no divisors other than 1 and itself.", "2\n3\n5\n7\n11\n13\n17\n19"),
      wordCpp("Compute and print the sum of all numbers from 1 to 100 that are divisible by 3 or by 5.", "2418"),
    ],
  },
];
