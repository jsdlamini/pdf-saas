export default function ToolPageLoading() {
  return (
    <main className="depth-stage mx-auto flex w-full max-w-5xl flex-1 flex-col gap-8 px-6 py-10 md:px-10">
      ...
      <section className="space-y-4 rounded-3xl border border-slate-200/60 bg-white/85 p-4 xl:p-5 shadow-sm">
        {/* Header */}
      ...
      <section className="space-y-3 rounded-2xl border border-slate-200/60 bg-white/85 p-4 shadow-sm">
